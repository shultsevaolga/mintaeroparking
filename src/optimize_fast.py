...
def optimize(
    ...
    for current_time in range(min_seconds, max_seconds+1, int(timedelta(minutes=5).total_seconds())):
...
def parse_arguments() -> argparse.Namespace:
    ...
    parser.add_argument("--output", default="../data/result_5AllRound.csv")
...
def main() -> None:
    ...
    handling_times_data = pd.read_csv(
        os.path.join(params.data_dir, "Handling_Time_Private_5round.csv"),
    ...
    aircraft_stands_data = pd.read_csv(os.path.join(params.data_dir, "Aircraft_Stands_Private_Round5.csv"), sep=",")
    aircraft_stands = [
    ...
    flight_stands = optimize(params.initial_date, list(aircraft_stand_clusters.values()),
                             flights, handling_rate, timeout)
